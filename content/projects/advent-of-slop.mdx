...
Finally, always be skeptical and take this with a grain of salt, it was a fun and simple experiment but no real conclusion can be taken.
For the curious, the code of the project is available at [divin1/advent-of-slop](https://github.com/divin1/advent-of-slop).
