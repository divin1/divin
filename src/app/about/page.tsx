    ...
    <div className="mx-auto mt-20 leading-relaxed md:max-w-prose">
      <div>
        ...
        <p>
          ...
          on a mission to bring innovation to one of the most traditional, slow-moving industries
          out there. We&rsquo;re using technology to challenge the status quo and it&rsquo;s as
        ...
        <p>
          ...
          people tick, I&rsquo;ve always loved learning how things work.
        </p>
        <p>
          Computer Science and its digital world instantly resonated with my need for expression.
          It&rsquo;s a vast, fast-evolving, fluid space, constantly shifting and expanding. It
        ...
        <p>
          ...
          my most beloved playground. I enjoy outdoor sports like trail running, alpinism and
          climbing &mdash; and while I might describe myself as a <i>type 2 fun</i> enjoyer,
          it&rsquo;s not just for the physical challenge, but mostly as a way to explore more of the
          alpine world I love. I see movement more as a means to discovery, rather than a sport and
          the end goal itself.
        </p>
        <p>
          I created this site to share my journey through the projects I&rsquo;m working on, ideas
          I&rsquo;m exploring and lessons I&rsquo;m learn.
        </p>
      ...
      <div className="mt-5">
        ...
        <p>
          ...
          available on GitHub, I grabbed it. Later, I went with divin for my website, it just stuck.
        </p>
      </div>
    </div>
  );
